SELECT 
groupedTable."Date" as "Date",
groupedTable."Project" as "Project Name",
groupedTable."UserName" AS "UserName",
SUM(groupedTable."expected Turnover")  AS "expected Turnover",
SUM(groupedTable."Planned Turnover")  AS "Planned Turnover",
SUM(groupedTable."Planned Turnover"/groupedTable."expected Turnover")*100 AS "Deviation"
FROM (
SELECT
...
GROUP BY groupedTable."Project", groupedTable."Date",groupedTable."UserName" 
