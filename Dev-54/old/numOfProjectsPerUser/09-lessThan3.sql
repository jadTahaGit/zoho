...
FROM  "Processed: PlannedTimes" AS  PlannedTime0
INNER JOIN(	SELECT
			 plannedTime2."Date" AS "Date",
			 plannedTime2."UserName" AS "UserName",
			 COUNT(DISTINCT plannedTime2."Project") AS NbrOfProjects
	FROM  "Processed: PlannedTimes" AS  plannedTime2 
	GROUP BY plannedTime2."Date",
		  plannedTime2."UserName" 
) AS  plannedTime1 ON plannedTime1."Date"  = PlannedTime0."Date"
