SELECT
		 ...
		 users."2022_hrl_rate_for_hq" AS "Hourly Rate",
		 ...
		 assignments."Id" AS "AssignmentId",		 
			CASE
				 ...
				 WHEN assignments."AssignmentUnit"  = 'Percent' THEN  (assignments."AssignmentValue" / 100)/amountWorkingDays."AmountWorkingDays"
...
JOIN "Companies" AS  companies ON companies."Id"  = projects."CompanyId" 
JOIN(	SELECT
