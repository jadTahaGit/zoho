...
UNION ALL
 SELECT
		 "Processed: Create Date"."Date" AS "Date",
		 "First Name",
		 "Last Name",
		 "Annual Revenue",
		 "Associated Company ID",
		 ...
		 NULL AS "Became a Customer Date",
		 NULL AS "Became a Lead Date",
		 "Processed: Create Date"."Date" AS "Create Date",
		 NULL AS "Became a Marketing Qualified Lead Date",
		 NULL AS "Became a Sales Qualified Lead Date",
		 NULL AS "Became a Subscriber Date",
		 NULL AS "Became an Opportunity Date",
...
UNION ALL
 SELECT
		 ...
		 NULL AS "Became a Marketing Qualified Lead Date",
		 NULL AS "Became a Sales Qualified Lead Date",
		 "Processed: Subscribers"."Date" AS "Became a Subscriber Date",
		 NULL AS "Became an Opportunity Date",
		 NULL AS "Became an Evangelist Date",
		 NULL AS "Close Date"
...
UNION ALL
 SELECT
		 ...
		 NULL AS "Became a Subscriber Date",
		 NULL AS "Became an Opportunity Date",
		 "Processed: Evangelists"."Date" AS "Became an Evangelist Date",
		 NULL AS "Close Date"
...
UNION ALL
 SELECT
		 ...
		 NULL AS "Became an Opportunity Date",
		 NULL AS "Became an Evangelist Date",
		 "Processed: Closed"."Date" AS "Close Date"
