SELECT groupedByIssue."Project" AS "Project",
        groupedByIssue."Issue Summary" AS "Issue Summary",
	   MAX(groupedByIssue."Original Estimate") AS "Original Estimate"
FROM(
SELECT
...
GROUP BY groupedByIssue."Project" , groupedByIssue."Issue Summary"
